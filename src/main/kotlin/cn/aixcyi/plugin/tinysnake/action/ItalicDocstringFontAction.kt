...
/**
 * 倾斜[文档字符串](https://docs.python.org/zh-cn/3/glossary.html#term-docstring)里选中的文本。
 *
 * @author <a href="https://github.com/aixcyi">砹小翼</a>
 * @see <a href="https://devguide.python.org/documentation/markup/">reStructuredText markup</a>
 */
class ItalicDocstringFontAction : DocstringAction(), DumbAware {
    ...
    override fun actionPerformed(editor: Editor, project: Project, selection: String): Any? {
        ...
        if (selection.isEmpty()) {
            WriteCommandAction.runWriteCommandAction(project, message("command.Docstring.ToggleItalic"), null, {
